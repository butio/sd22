...
/**
 * Servlet implementation class memberChangeOutput
 */
@WebServlet("/memberChangeOutput")
public class memberChangeOutput extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public memberChangeOutput() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//エラーがあれば入力画面に遷移する
		String fileJsp = "/memberChangeRusult.jsp";
		if(m.getJsp()){
			fileJsp = "/memberChange.jsp";
		}
